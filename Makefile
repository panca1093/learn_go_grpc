...
.DEFAULT_GOAL := help
.PHONY: hello blog calculator help
project := hello calculator blog

all: $(project) ## Generate Pbs and build

hello: $@ ## Generate Pbs and build for hello
...
clean: clean_hello clean_calculator clean_blog ## Clean generated files
	${RM_F_CMD} ssl/*.crt
	${RM_F_CMD} ssl/*.csr
	${RM_F_CMD} ssl/*.key
	${RM_F_CMD} ssl/*.pem
...
clean_hello: ## Clean generated files for hello
